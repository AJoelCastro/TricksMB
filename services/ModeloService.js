      ...
      if (error.response) {
        ...
        throw new Error(
          error.response.data.error ||
            `Error en obtener todos los modelos: ${error.response.status}`
        );
        ...
        // Otro tipo de error
        throw new Error(
          'Ocurrió un error inesperado al obtener todos los modelos.'
        );
      }
    }
  },
  getAllModeloById: async id => {
    try {
      ...
      if (error.response) {
        ...
        throw new Error(
          error.response.data.error ||
            `Error en obtener modelo por id: ${error.response.status}`
        );
      } else if (error.request) {
        console.log('error.request', error.request);
        // No hubo respuesta del servidor
        ...
        // Otro tipo de error
        throw new Error(
          'Ocurrió un error inesperado al obtener modelo por id.'
        );
      }
    }
  },
  getModeloByCodigoPedido: async codigoPedido => {
    try {
      ...
      const response = await axios.get(
        `${API_URL}/modelo/obtener/${codigoPedido}`,
        {
          headers: { Authorization: `Bearer ${token}` },
        }
      );
      ...
      if (error.response) {
        ...
        throw new Error(
          error.response.data.error ||
            `Error en obtener modelo por codigo de pedido: ${error.response.status}`
        );
      } else if (error.request) {
        console.log('error.request', error.request);
        // No hubo respuesta del servidor
        ...
        // Otro tipo de error
        throw new Error(
          'Ocurrió un error inesperado al obtener modelo por codigo de pedido.'
        );
      }
    }
  },
  ...
  getInventario: async () => {
    try {
      ...
      if (error.response) {
        ...
        throw new Error(
          error.response.data.error ||
            `Error en obtener inventario: ${error.response.status}`
        );
      } else if (error.request) {
        console.log('error.request', error.request);
        // No hubo respuesta del servidor
